...
const zhCN: Record<string, string> = {
  ...
  "sidePane.review": "审查",
  // Harness Router strings are intentionally English-only for now.
  "sidePane.harnessRouter": "Harness Router",
  "harnessRouter.description": "Pick which model backend new sessions route to.",
  "harnessRouter.currentRoute": "Current route: {route}",
  "harnessRouter.automatic": "Automatic",
  "harnessRouter.automaticHint": "Follow provider order",
  "harnessRouter.disabled": "Disabled",
  "harnessRouter.loading": "Loading harnesses…",
  "harnessRouter.loadError": "Could not load harnesses.",
  "harnessRouter.unavailable": "Model selection is unavailable right now.",
  "harnessRouter.saveError": "Could not save the route. Please try again.",
  "harnessRouter.noProviders": "No providers configured. Add one in Settings to route to it.",
  "harnessRouter.footerHint": "Click a model to route the open session; star it to make it the default for new sessions.",
  "harnessRouter.routeSession": "Route open session",
  "harnessRouter.setDefault": "Set as default",
  "harnessRouter.sessionRouted": "Open session now routes to {route}",
  "harnessRouter.sessionNotOpen": "No open session to route.",
  "harnessRouter.externalTitle": "External harnesses",
  "harnessRouter.externalHint": "Routable CLIs execute the open session in the background; others open in a workspace terminal.",
  "harnessRouter.externalLaunch": "Open in terminal",
  "harnessRouter.externalBuiltin": "Built-in",
  "harnessRouter.externalInstalled": "Installed",
  "harnessRouter.externalMissing": "Not installed",
  "harnessRouter.externalUnknown": "Detection unavailable",
  "harnessRouter.externalLaunched": "Opened {harness} in a new terminal",
  "harnessRouter.routableHint": "Click to route the open session here",
  "harnessRouter.routedBadge": "Routed",
  "harnessRouter.consentGrant": "Allow this harness to execute routed turns",
  "harnessRouter.consentRevoke": "Revoke execution consent",
  "harnessRouter.consentGranted": "{harness} may now execute routed turns",
  "harnessRouter.consentRevoked": "{harness} execution consent revoked",
  "harnessRouter.autoRoute": "Smart auto-route",
  "harnessRouter.autoRouteHint": "New drafts pick a model from the draft text when no explicit route is set",
  "harnessRouter.smartRoute": "Smart route",
  "harnessRouter.smartRouteHint": "Route the open session from its draft text",
  "harnessRouter.smartRouteEmpty": "The open draft is empty; nothing to analyze.",
  "harnessRouter.smartRouteNone": "No model stands out for this draft; keeping the current route.",
  "harnessRouter.smartRouteWithFallbacks": "Open session now routes to {route} (fallbacks: {fallbacks})",
  "harnessRouter.apiHint":
    "API providers (MiniMax, Z.AI, LM Studio, …) are added in Settings → Model Providers, then appear above.",
  "quickPick.command.openHarnessRouter": "Open Harness Router",
  "whiteboard.title": "画板",
